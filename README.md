<h1 align="center">Hi there 👋, I'm Rapding!</h1>

<!-- Typing Effect -->
<p align="center">
  <a href="https://github.com/Rappbukansepuh">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=22&pause=1000&color=36BCF7&center=true&vCenter=true&width=600&lines=Software+Engineering+Student;Mobile+%26+Web+Developer;Game+Dev+%26+Cybersec+Enthusiast" alt="Typing SVG" />
  </a>
</p>

<p align="center">
  I'm a passionate <b>Software Engineering & Game Development Student</b> from Indonesia, deeply interested in building impactful applications, exploring mobile development, and diving into the world of cybersecurity.
</p>
...
- 🔭 **Currently working on:** Building and deploying school-related applications (like **KasClass** and other finance/attendance apps) using modern frameworks, Android Studio, and cloud databases.
- 🌱 **Currently learning:** Advanced mobile programming (React Native, Java), Backend Development (Supabase, Node.js, Railway), and the fundamentals of Cybersecurity (TryHackMe, Linux).
- 💬 **Ask me about:** Frontend/Mobile Development, UI/UX designing in Figma & Canva, creating automated bots (Telegram/WA), or why AI tools (like Cursor & Claude) make a programmer's life 10x easier.
- ⚡ **Fun fact:** I love experimenting with prompt engineering, scripting 2D games, and finding slick design inspirations on Dribbble.
